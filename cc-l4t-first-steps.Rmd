# Linux for Tegra (L4T) First Steps
...
knitr::include_graphics('./images/software-updater-app.jpg')
```
...
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('./images/software-updater-dialog.png')
```
...
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('./images/restart-dialog.png')
```
...
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('./images/ip-address.png')
```
...
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('./images/ssh-to-nano.png')
```
...
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('./images/l4t-readme.jpg')
```
...
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('./images/README-vnc.png')
```
...
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('./images/configuring-vnc.png')
```
